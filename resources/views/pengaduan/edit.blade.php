    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="/dashboard/pengaduan/{{ $pengaduan->id }}" method="post"
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror " placeholder="Tempat, tanggal lahir" name="ttl_pelapor"
                                        value="{{ old('ttl_pelapor', $pengaduan->ttl_pelapor) }}" />
                                    @error('ttl_pelapor')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror " placeholder="Usia" name="usia_pelapor"
                                        value="{{ old('usia_pelapor', $pengaduan->usia_pelapor) }}" />
                                    @error('usia_pelapor')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" id="flexRadioDefault1"
                                            ...
                                            @checked(old('jenis_kelamin_pelapor',
                                            $pengaduan->jenis_kelamin_pelapor)==='laki-laki' ) />
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="flexRadioDefault2"
                                            ...
                                            @checked(old('jenis_kelamin_pelapor',$pengaduan->jenis_kelamin_pelapor)==='perempuan'
                                        ) />
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror " name="agama_pelapor" placeholder="Agama"
                                        value="{{ old('agama_pelapor', $pengaduan->agama_pelapor) }}" />
                                    @error('agama_pelapor')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" placeholder="Kewarganegaraan" name="kewarganegaraan_pelapor"
                                        value="{{ old('kewarganegaraan_pelapor', $pengaduan->kewarganegaraan_pelapor) }}" />
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" name="suku_pelapor" placeholder="Suku"
                                        value="{{ old('suku_pelapor', $pengaduan->suku_pelapor) }}" />
                                    @error('suku_pelapor')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror " name="pendidikan_pelapor" placeholder="Pendidikan"
                                        value="{{ old('pendidikan_pelapor', $pengaduan->pendidikan_pelapor) }}" />
                            ...
                            <div class=" col-12">
                                <div class="form-group">
                                    ...
                                    @enderror " name="hubungan_pelapor" placeholder="Hubungan Pelapor"
                                        value="{{old('hubungan_pelapor', $pengaduan->hubungan_pelapor)}}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="domisili_pelapor" name="domisili_pelapor">
                                        ...
                                        @if (old('domisili_pelapor', $pengaduan->domisili_pelapor) === 'kabupaten')
                                        ...
                                        <option value="kabupaten">
                                            Kabupaten</option>
                                        @endif
                                        @if (old('domisili_pelapor',$pengaduan->domisili_pelapor) === 'provinsi')
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" name="nama_domisili_pelapor" placeholder="Nama Provinsi/Kabupaten"
                                        value="{{ old('nama_domisili_pelapor',$pengaduan->nama_domisili_pelapor) }}" />
                            ...
                            <div class="col-md-10 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" id="alamat_pelapor" rows="2"
                                        name="alamat_pelapor">{{ old('alamat_pelapor',$pengaduan->alamat_pelapor) }}</textarea>
                            ...
                            <div class="col-md-2 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" name="kode_pos_pelapor" placeholder="Kode pos"
                                        value="{{ old('kode_pos_pelapor',$pengaduan->kode_pos_pelapor) }}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_pelaku" class="form-control @error('nama_pelaku')
                                        ...
                                        value="{{ old('nama_pelaku',$pengaduan->nama_pelaku)}}" />
                                    @error('nama_pelaku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror " placeholder="Tempat, tanggal lahir" name="ttl_pelaku"
                                        value="{{ old('ttl_pelaku',$pengaduan->ttl_pelaku) }}" />
                                    @error('ttl_pelaku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="usia_pelaku"
                                        ...
                                        placeholder="Usia" name="usia_pelaku"
                                        value="{{ old('usia_pelaku',$pengaduan->usia_pelaku) }}" />
                                    @error('usia_pelaku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nik_pelaku"
                                        ...
                                        value="{{ old('nik_pelaku',$pengaduan->nik_pelaku) }}" />
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" id="flexRadioDefault3"
                                            ...
                                            @checked(old('jenis_kelamin_pelaku',$pengaduan->jenis_kelamin_pelaku)==='laki-laki'
                                        ) />
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="flexRadioDefault4"
                                            ...
                                            @checked(old('jenis_kelamin_pelaku',$pengaduan->jenis_kelamin_pelaku)==='perempuan'
                                        ) />
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="agama_pelaku"
                                        ...
                                        name="agama_pelaku" placeholder="Agama"
                                        value="{{ old('agama_pelaku',$pengaduan->agama_pelaku) }}" />
                                    @error('agama_pelaku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kewarganegaraan_pelaku"
                                        ...
                                        value="{{ old('kewarganegaraan_pelaku',$pengaduan->kewarganegaraan_pelaku) }}" />
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="suku_pelaku"
                                        ...
                                        name="suku_pelaku" placeholder="Suku"
                                        value="{{ old('suku_pelaku',$pengaduan->suku_pelaku) }}" />
                                    @error('suku_pelaku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pekerjaan_pelaku"
                                        ...
                                        value="{{old('pekerjaan_pelaku',$pengaduan->pekerjaan_pelaku)}}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pendidikan_pelaku"
                                        ...
                                        value="{{ old('pendidikan_pelaku',$pengaduan->pendidikan_pelaku) }}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email_pelaku"
                                        ...
                                        placeholder="Email" name="email_pelaku"
                                        value="{{ old('email_pelaku',$pengaduan->email_pelaku) }}" />
                                    @error('email_pelaku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nohp_pelaku"
                                        ...
                                        value="{{ old('nohp_pelaku',$pengaduan->nohp_pelaku) }}" />
                                    @error('nohp_pelaku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class=" col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="hubungan_pelaku"
                                        ...
                                        value="{{old('hubungan_pelaku',$pengaduan->hubungan_pelaku)}}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="domisili_pelaku" name="domisili_pelaku">
                                        <option selected disabled> Pilih daerah</option>
                                        @if (old('domisili_pelaku',$pengaduan->domisili_pelaku) === 'kabupaten')
                                        <option value="kabupaten" selected>
                                            Kabupaten</option>
                                        @else
                                        <option value="kabupaten">
                                            Kabupaten</option>
                                        @endif
                                        @if (old('domisili_pelaku',$pengaduan->domisili_pelaku) === 'provinsi')
                                        <option value="provinsi" selected>
                                            Provinsi</option>
                                        @else
                                        <option value="provinsi">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_domisili_pelaku"
                                        ...
                                        value="{{ old('nama_domisili_pelaku',$pengaduan->nama_domisili_pelaku) }}" />
                            ...
                            <div class="col-md-10 col-12">
                                <div class="form-group">
                                    ...
                                    is-invalid @enderror" id="alamat_pelaku" rows="2"
                                        name="alamat_pelaku">{{ old('alamat_pelaku',$pengaduan->alamat_pelaku) }}</textarea>
                                    @error('alamat_pelaku')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-2 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kode_pos_pelaku"
                                        ...
                                        value="{{ old('kode_pos_pelaku',$pengaduan->kode_pos_pelaku) }}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_korban"
                                        ...
                                        placeholder="Nama Lengkap" name="nama_korban"
                                        value="{{ old('nama_korban',$pengaduan->nama_korban)}}" />
                                    @error('nama_korban')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ttl_korban"
                                        ...
                                        value="{{ old('ttl_korban',$pengaduan->ttl_korban) }}" />
                                    @error('ttl_korban')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="usia_korban"
                                        ...
                                        placeholder="Usia" name="usia_korban"
                                        value="{{ old('usia_korban',$pengaduan->usia_korban) }}" />
                                    @error('usia_korban')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nik_korban"
                                        ...
                                        value="{{ old('nik_korban',$pengaduan->nik_korban) }}" />
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" id="flexRadioDefault5"
                                            ...
                                            @checked(old('jenis_kelamin_korban',$pengaduan->jenis_kelamin_korban)==='laki-laki'
                                        ) />
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="flexRadioDefault6"
                                            ...
                                            @checked(old('jenis_kelamin_korban',$pengaduan->jenis_kelamin_korban)==='perempuan'
                                        ) />
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="agama_korban"
                                        ...
                                        name="agama_korban" placeholder="Agama"
                                        value="{{ old('agama_korban',$pengaduan->agama_korban) }}" />
                                    @error('agama_korban')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kewarganegaraan_korban"
                                        ...
                                        value="{{ old('kewarganegaraan_korban',$pengaduan->kewarganegaraan_korban) }}" />
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="suku_korban"
                                        ...
                                        name="suku_korban" placeholder="Suku"
                                        value="{{ old('suku_korban',$pengaduan->suku_korban) }}" />
                                    @error('suku_korban')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pekerjaan_korban"
                                        ...
                                        value="{{old('pekerjaan_korban',$pengaduan->pekerjaan_korban)}}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pendidikan_korban"
                                        ...
                                        value="{{ old('pendidikan_korban',$pengaduan->pendidikan_korban) }}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="domisili_korban" name="domisili_korban">
                                        <option selected disabled> Pilih daerah</option>
                                        @if (old('domisili_korban',$pengaduan->domisili_korban) === 'kabupaten')
                                        <option value="kabupaten" selected>
                                            Kabupaten</option>
                                        @else
                                        <option value="kabupaten">
                                            Kabupaten</option>
                                        @endif
                                        @if (old('domisili_korban',$pengaduan->domisili_korban) === 'provinsi')
                                        <option value="provinsi" selected>
                                            Provinsi</option>
                                        @else
                                        <option value="provinsi">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama_domisili_korban"
                                        ...
                                        value="{{ old('nama_domisili_korban',$pengaduan->nama_domisili_korban) }}" />
                            ...
                            <div class="col-md-10 col-12">
                                <div class="form-group">
                                    ...
                                    is-invalid @enderror" id="alamat_korban" rows="2"
                                        name="alamat_korban">{{ old('alamat_korban',$pengaduan->alamat_korban) }}</textarea>
                                    @error('alamat_korban')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-2 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kode_pos_korban"
                                        ...
                                        value="{{ old('kode_pos_korban',$pengaduan->kode_pos_korban) }}" />
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" placeholder="Perkara yang dilaporkan" name="perkara_pelaporan"
                                        value="{{ old('perkara_pelaporan',$pengaduan->perkara_pelaporan) }}" />
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" placeholder="Perkara yang dilaporkan" name="pasal_pelaporan"
                                        value="{{ old('pasal_pelaporan',$pengaduan->pasal_pelaporan) }}" />
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" placeholder="Waktu kejadian" name="waktu_kejadian"
                                        value="{{ old('waktu_kejadian', $pengaduan->waktu_kejadian) }}" />
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" placeholder="Tempat kejadian" name="tempat_kejadian"
                                        value="{{ old('tempat_kejadian',$pengaduan->tempat_kejadian) }}" />
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="saksi1" class="form-control @error('saksi1')
                                        is-invalid
                                    @enderror" placeholder="Saksi 1" name="saksi1"
                                        value="{{ old('saksi1',$pengaduan->saksi1) }}" />
                                    @error('saksi1')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="saksi2" class="form-control @error('saksi2')
                                        is-invalid
                                    @enderror" placeholder="Saksi 2" name="saksi2"
                                        value="{{ old('saksi2',$pengaduan->saksi2) }}" />
                                    @error('saksi2')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    @enderror" id="kronologi" rows="5"
                                        name="kronologi">{{ old('kronologi',$pengaduan->kronologi) }}</textarea>
                                    @error('kronologi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    @if ($pengaduan->bukti1)
                                    <img src="{{ asset('storage/'.$pengaduan->bukti1) }}"
                                        class="img-preview1  img-fluid mb-2 mt-2 rounded">
                                    @else
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    @if ($pengaduan->bukti2)
                                    <img src="{{ asset('storage/'.$pengaduan->bukti2) }}"
                                        class="img-preview2  img-fluid mb-2 mt-2 rounded">
                                    @else
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    @if ($pengaduan->bukti3)
                                    <img src="{{ asset('storage/'.$pengaduan->bukti3) }}"
                                        class="img-preview3  img-fluid mb-2 mt-2 rounded ">
                                    @else
