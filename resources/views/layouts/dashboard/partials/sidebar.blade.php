    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @endcan
                <li class="sidebar-item {{ Request::is('dashboard/myprofile*') ? 'active' : false }}">
                    <a href="/dashboard/myprofile/user" class="sidebar-link">
                        <i class="bi bi-person-fill"></i>
                        <span>My Profile</span>
                    </a>
                </li>
                <li class="sidebar-item {{ Request::is('dashboard/pengaduan*') ? 'active' : false }}">
                    <a href="/dashboard/pengaduan" class="sidebar-link">
